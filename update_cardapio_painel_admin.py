...
cardapio_data = [
    {"name": "CORINGA", "category": "burguers", "price": 40, "image": "./assets/coringa.png", "description": "Pão de abóbora, 2x burger 150g, 2x mussarela, 2x bacon, 2x cebola caramelizada, molho especial, maionese.", "ativo": True},
    {"name": "DARTH VADER", "category": "burguers", "price": 40, "image": "./assets/darth-vader.png", "description": "Pão de abóbora, 2x burger 150g, 2x cheddar, 2x bacon, 2x cebola caramelizada, molho barbecue, maionese.", "ativo": True},
    ...
    {"name": "LEX LUTHOR", "category": "burguers", "price": 30, "image": "./assets/lex-luthor.png", "description": "Pão americano, barbecue, burger 150g, cheddar, bacon, cebola caramelizada, maionese.", "ativo": True},
    ...
    {"name": "RAINHA DE COPAS", "category": "burguers", "price": 26, "image": "./assets/rainha-copas.png", "description": "Pão americano, molho especial, maionese, burger 150g, mussarela, tomate, alface americana, cebola roxa e maionese.", "ativo": True},
    {"name": "MANJIM BOO", "category": "burguers", "price": 32, "image": "./assets/manjim-boo.png", "description": "Pão de abóbora, molho especial, ketchup, burger 150g, frango com ervas 100g, mussarela, tomate roxa, maionese.", "ativo": True},
    ...
    {"name": "EXTERMINATOR - T800", "category": "burguers", "price": 42, "image": "./assets/exterminator.png", "description": "Pão australiano, 3x burger 150g, 3x cheddar e cebola roxa.", "ativo": True},
    ...
    {"name": "ANABELE (Autoral) - 8 pedaços", "category": "pizzas", "price": 75, "image": "./assets/anabele.png", "description": "Massa de longa fermentação, molho de tomate, frango, requeijão, bacon, alho frito e mussarela.", "ativo": True, "monteEnabled": True},
    {"name": "ANA KARENINA (Autoral) - 8 pedaços", "category": "pizzas", "price": 90, "image": "./assets/ana-karenina.png", "description": "Massa de longa fermentação, molho de tomate, mussarela, bacon, alho frito e mussarela.", "ativo": True, "monteEnabled": True},
...
let menu = [
  ...
  {name: "ANABELE (Autoral) - 8 pedaços", category: "pizzas", price: 75.00, image: "./assets/anabele.png", description: "Massa de longa fermentação, molho de tomate, frango, requeijão, bacon, alho frito e mussarela.", ativo: true, monteEnabled: true},
  {name: "ANA KARENINA (Autoral) - 8 pedaços", category: "pizzas", price: 90.00, image: "./assets/ana-karenina.png", description: "Massa de longa fermentação, molho de tomate, mussarela, bacon, alho frito e mussarela.", ativo: true, monteEnabled: true},

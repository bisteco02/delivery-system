...
let menu = [
  ...
  {name: "ANABELE (Autoral) - 8 pedaços", category: "pizzas-8", price: 75.00, image: "./assets/anabele.jpg", description: "Massa de longa fermentação, molho de tomate, frango, requeijão, bacon, alho frito e mussarela.", ativo: true, monteEnabled: true},
  {name: "ANA KARENINA (Autoral) - 8 pedaços", category: "pizzas-8", price: 90.00, image: "./assets/ana karienina.avif", description: "Massa de longa fermentação, molho de tomate, mussarela, bacon, alho frito e mussarela.", ativo: true, monteEnabled: true},
  ...
  {name: "ANABELE (Autoral) - 4 pedaços", category: "pizzas-4", price: 37.50, image: "./assets/anabele.jpg", description: "Massa de longa fermentação, molho de tomate, frango, requeijão, bacon, alho frito e mussarela.", ativo: true},
  {name: "ANA KARENINA (Autoral) - 4 pedaços", category: "pizzas-4", price: 45.00, image: "./assets/ana karienina.avif", description: "Massa de longa fermentação, molho de tomate, mussarela, bacon, alho frito e mussarela.", ativo: true},
